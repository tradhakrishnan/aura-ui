...
const USE_CASES: UseCase[] = [
  {
    ...
    scenario: 'A user EID is missing a required system permission — Revenue Manager in CRS-2, rate access in CRS-1, location visibility in MITE, or identity in IAM. AURA diagnoses the gap, classifies risk, gets human approval, patches the permission, validates, and auto-closes.',
    ...
    steps: [
      ...
      'SPA queries SAP Query + IAM for user profile & permissions',
      ...
      'EA patches permission via SAP Updater API',
    ...
    systems: ['SAP Query :8081', 'SAP Updater :8082', 'IAM :8086'],
  },
  {
    id: 'hotel',
    ...
    steps: [
      ...
      'SPA queries CRS-1 for location record and controlledHotels array',
      'SME cross-references CRS-2 to confirm hotel code validity',
      ...
      'VA queries CRS-1 to verify hotel appears in location',
    ...
    systems: ['CRS-1 :8083', 'CRS-2 :8085', 'SAP Updater :8082'],
  },
  {
    id: 'multisystem',
    ...
    scenario: 'Complex incidents span multiple systems — issues visible in CRS-1 but originating in CRS-2, or config conflicts between MITE and IAM. SPA and SME engage in iterative discussion up to 3 rounds to reach consensus on root cause before producing a targeted fix plan.',
    ...
    systems: ['CRS-1 :8083', 'CRS-2 :8085', 'MITE :8084', 'IAM :8086'],
  },
  {
    id: 'jira',
  ...
  },
  {
    ...
    systems: ['MongoDB (state)', 'AURA UI :3000', 'SAP Updater :8082'],
  },
  {
    id: 'audit',
