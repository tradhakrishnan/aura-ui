...
const DataSources = () => (
  <div className="fd-column fd-sources">
    ...
    <div className="fd-source-box">
      ...
      <div>
        <div className="fd-source-title">Application Service APIs</div>
        <div className="fd-source-chips">
    ...
    <div className="fd-source-box">
      <div className="fd-source-icon">📖</div>
      <div>
        <div className="fd-source-title">Application Functions</div>
        <div className="fd-source-chips">
...
const RequestIntakeAgent = () => (
  <div className="fd-column fd-intake">
    <div className="fd-intake-wrapper">
      <div className="fd-intake-icon">📥</div>
      <div className="fd-intake-title">Request Intake<br />Agent</div>
      <div className="fd-intake-chips">
        <span className="fd-intake-chip">Ticket Parsing</span>
        <span className="fd-intake-chip">Classification</span>
        <span className="fd-intake-chip">Problem Framing</span>
      </div>
    </div>
  </div>
)
...
const TechSupportTeam = () => (
  <div className="fd-column fd-support-team">
    <div className="fd-team-wrapper">
      <div className="fd-team-label-inside">System Diagnostics Agent</div>
      <div className="fd-researcher-box fd-amber">
        <div className="fd-researcher-icon">🔍</div>
        <div className="fd-researcher-label amber">Problem Root Cause<br />Analysis (RCA)</div>
      </div>
      <div className="fd-discussion-pill"><span>⇅</span> Technical Discussion</div>
      <div className="fd-outcome-row">
...
const TechLead = () => (
  <div className="fd-column fd-tech-lead">
    <div className="fd-lead-wrapper">
      ...
      <div className="fd-lead-title">Expert Advisor Agent</div>
      <div className="fd-lead-subtitle">(Domain Expert)</div>
...
const RiskManagement = () => (
  <div className="fd-column fd-risk">
    <div className="fd-risk-header">Risk Evaluator Agent</div>
...
const ValidationAgent = () => (
  <div className="fd-validation">
    <div className="fd-validation-header">
      ...
      <span className="fd-validation-title">Change Validation Agent</span>
    </div>
...
const TicketClosed = () => (
  <div className="fd-ticket-closed">
    <div className="fd-ticket-agent-label">Resolution Agent</div>
...
const RightSection = () => (
  <div className="fd-right-section">
    ...
    <div className="fd-po-box">
      <div className="fd-po-title">Change Approver (Manual)</div>
      <div className="fd-person-avatar">
        <svg viewBox="0 0 40 40" width="40" height="40">
...
const TeamOverview = () => (
  <div className="fd-team-overview">
    ...
    <div className="fd-overview-content">
      <div className="fd-overview-title">Framework Overview</div>
      <div className="fd-overview-rows">
        <div className="fd-overview-row"><span className="fd-overview-role">Request Intake Agent:</span> Classifies &amp; frames the ticket</div>
        <div className="fd-overview-row"><span className="fd-overview-role">System Diagnostics Agent:</span> Evaluates issue, impact &amp; root cause</div>
        <div className="fd-overview-row"><span className="fd-overview-role">Expert Advisor Agent:</span> Confirms root cause with domain expertise</div>
        <div className="fd-overview-row"><span className="fd-overview-role">Risk Evaluator Agent:</span> Manages escalation priority &amp; risk level</div>
        <div className="fd-overview-row"><span className="fd-overview-role">Change Approver (Manual):</span> Human authorizes execution</div>
        <div className="fd-overview-row"><span className="fd-overview-role">Change Validation Agent:</span> Verifies fix via microservice health checks</div>
      </div>
    </div>
  </div>
)
...
export default function FrameworkDiagram() {
  ...
  useEffect(() => {
    const recalc = () => {
      ...
      const available = containerRef.current.clientWidth - 32 // 1rem padding each side
      const natural   = diagramRef.current.scrollWidth / zoom  // undo current zoom first
      // Allow scale-up (> 1) to fill available space, cap at 2.0, floor at 0.4
      const next = Math.max(0.4, Math.min(2.0, available / natural))
      setZoom(next)
    }
    recalc()
    ...
    <div className="fd-container" ref={containerRef}>
      <div className="fd-section-header">
        ...
        <p className="fd-section-desc">
          Specialized LLM-powered agents collaborate in real time — from the Request Intake and
          System Diagnostics agents, through Expert Advisor and Risk Evaluator agents, to a human
          Change Approver — to diagnose, escalate, implement, validate and auto-close production incidents end-to-end.
        </p>
      </div>

      <div className="fd-diagram" ref={diagramRef} style={{ zoom }}>
        <DataSources />
        ...
        <HArrow label={'Transaction\nProposal'} wide color="#a5b4fc" />

        <RiskManagement />

        <HArrow label="Decision" wide color="#a5b4fc" />
